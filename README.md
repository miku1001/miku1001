...
<div align="center">
  <span style="display: inline-block; border: 2px solid white; border-radius: 8px; padding: 6px; background: #1a1a1a;">
  ...
  <img width="12" />
  <span style="display: inline-block; border: 2px solid white; border-radius: 8px; padding: 6px; background: #1a1a1a;">
    <img src="https://cdn.simpleicons.org/langchain" height="50" alt="langchain logo" />
  </span>
  <img width="12" />
  <span style="display: inline-block; border: 2px solid white; border-radius: 8px; padding: 6px; background: #1a1a1a;">
